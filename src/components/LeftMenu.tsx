    ...
    <>
      <div className={classes} ref={ref}>
        ...
        <div className="flex flex-col flex-shrink flex-grow overflow-y-auto mb-0.5 px-4">
          ...
          {/* Teams */}
          <h3 className="px-2 mt-5 text-xs text-gray-500">Favourites</h3>
          <ItemGroup title="Github Integration">{}</ItemGroup>
          <ItemGroup title="Warp Mode">{}</ItemGroup>

          {/* Teams */}
          <h3 className="px-2 mt-5 text-xs text-gray-500">Your teams</h3>

          <ItemGroup title="Engineering">
            <Link
              to="/"
